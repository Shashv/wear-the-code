        ...
        <>
            ...
            <div className={showMobilefilter ? style.showfiltercontent : style.hidefiltercontent}>
                <div className={theme.light ? style.mobilefilterlight : style.mobilefilterdark}>
                    {
                        showMobilefilter ? <IoMdClose className={showMobilefilter ? style.menuClose : style.menuOpen} color="#ec4899" onClick={(e) => { toggleMobileFilter(); controlFilter(showMobilefilter) }} /> : <IoMenu className={showMobilefilter ? style.menuClose : style.menuOpen} color="#ec4899" onClick={e => { toggleMobileFilter(); controlFilter(showMobilefilter) }} />
                    }
                    <div className={style.filterheading}>
                    ...
                    <div className="">
                        <button className="bg-pink-600 rounded-pill text-light text-1xl p-2 px-3" onClick={() => { setShowMobilefilter(false); controlFilter(showMobilefilter) }}>
                            Apply Filters
                        </button>
                    </div>
                </div>
